...
// Cores (usando nomes iguais aos diretórios dentro de /src/imagens/opcoes-cores)
const verdeCipreste = {
  nome: "Verde-cipreste",
...
function atualizarCorSelecionada() {
  ...
  imagemVisualizacao.src = `./src/assets/imagens/opcoes-cores/${opcoesCores[corSelecionada].nomePastaImagens}/imagem-${imagemSelecionada}.jpeg`;
  opcaoImagem0.src = `./src/assets/imagens/opcoes-cores/${opcoesCores[corSelecionada].nomePastaImagens}/imagem-0.jpeg`;
  opcaoImagem1.src = `./src/assets/imagens/opcoes-cores/${opcoesCores[corSelecionada].nomePastaImagens}/imagem-1.jpeg`;
  opcaoImagem2.src = `./src/assets/imagens/opcoes-cores/${opcoesCores[corSelecionada].nomePastaImagens}/imagem-2.jpeg`;
}
